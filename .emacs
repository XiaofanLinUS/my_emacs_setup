...
;; (defun line-toggle ()
;;   (interactive)
;;    (if (bound-and-true-p term-line-mode)
;;       (term-char-mode)
;;     (term-line-mode)))
...
(global-set-key (kbd "C-c M-z") 'term-line-mode)
(global-set-key (kbd "C-c M-c") 'term-char-mode)
